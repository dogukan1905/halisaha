...
ActiveRecord::Schema.define(version: 20170123234629) do
  ...
  create_table "votings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["player_id"], name: "index_votings_on_player_id", using: :btree
    t.index ["vote_id"], name: "index_votings_on_vote_id", using: :btree
  end
